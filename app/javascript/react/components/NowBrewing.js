...
class NowBrewing extends Component {
  ...
  //         waveHeightScale = d3.scaleOrdinal.linear()
  ...
  //     var gaugeCircleX = d3.scaleOrdinal.linear().range([0,2*Math.PI]).domain([0,1]);
  //     var gaugeCircleY = d3.scaleOrdinal.linear().range([0,radius]).domain([0,radius]);
  //
  //     // Scales for controlling the size of the clipping path.
  //     var waveScaleX = d3.scaleOrdinal.linear().range([0,waveClipWidth]).domain([0,1]);
  //     var waveScaleY = d3.scaleOrdinal.linear().range([0,waveHeight]).domain([0,1]);
  //
  //     // Scales for controlling the position of the clipping path.
  //     var waveRiseScale = d3.scaleOrdinal.linear()
  //         // The clipping area size is the height of the fill circle + the wave height, so we position the clip wave
  //         // such that the it will overlap the fill circle at all when at 0%, and will totally cover the fill
  //         // circle at 100%.
  //         .range([(fillCircleMargin+fillCircleRadius*2+waveHeight),(fillCircleMargin-waveHeight)])
  //         .domain([0,1]);
  //     var waveAnimateScale = d3.scaleOrdinal.linear()
  //         .range([0, waveClipWidth-fillCircleRadius*2]) // Push the clip area one full wave then snap back.
  //         .domain([0,1]);
  //
  //     // Scale for controlling the position of the text within the gauge.
  //     var textRiseScaleY = d3.scaleOrdinal.linear()
        ...
        <div className="scriptHeader">
          ...
          <div className="gaugesWrapper">
            <div className="gaugeBlock">
              ...
              <svg id="fillgauge1" width="45%"></svg>
              <svg id="fillgauge2" width="45%"></svg>
            </div>
            <div className="gaugeBlock">
              <svg id="fillgauge3" width="45%"></svg>
              <svg id="fillgauge4" width="45%"></svg>
            </div>
            <div className="gaugeBlock">
              <svg id="fillgauge5" width="45%"></svg>
              <svg id="fillgauge6" width="45%"></svg>
            </div>
